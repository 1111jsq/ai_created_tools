...
```bash
# 从项目根目录运行
uv run python -m get_agent_news.src.main --once --source all --news-since-days 7 --export-markdown --stop-on-duplicate-daily
```
